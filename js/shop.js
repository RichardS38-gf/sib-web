...
function renderInfoBar (shop, produktAnzahl, bewertungSchnitt, bewertungAnzahl) {
  ...
  const whatsappIcon = whatsappHref
    ? ` <a href="${whatsappHref}" target="_blank" rel="noopener" class="shop-infobar__whatsapp" aria-label="Auch per WhatsApp erreichbar" title="Auch per WhatsApp erreichbar"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M12.04 2c-5.52 0-10 4.48-10 10 0 1.76.46 3.48 1.34 5L2 22l5.13-1.35a9.96 9.96 0 004.91 1.29h.01c5.52 0 10-4.48 10-10s-4.48-10-10.01-10zm5.86 14.27c-.25.7-1.45 1.34-2 1.42-.55.09-1.19.13-3.32-.7-2.79-1.11-4.58-3.94-4.72-4.13-.14-.18-1.13-1.5-1.13-2.87s.71-2.03.96-2.31c.25-.28.55-.35.73-.35.18 0 .37 0 .53.01.17.01.4-.06.62.48.25.6.85 2.08.93 2.23.08.15.13.33.03.53-.1.2-.15.32-.3.49-.15.17-.31.38-.44.51-.15.15-.31.31-.13.61.18.3.79 1.31 1.7 2.12 1.17 1.04 2.16 1.37 2.46 1.52.3.15.47.13.65-.08.18-.2.76-.89.97-1.19.2-.3.4-.25.68-.15.28.1 1.76.83 2.06.98.3.15.5.23.57.35.08.13.08.72-.17 1.42z"/></svg></a>`
    : ''
  const telefonZeile = shop.telefon
    ? `<span class="shop-infobar__ort"><svg viewBox="0 0 24 24" width="14" height="14" style="margin-right:4px;vertical-align:-2px;flex-shrink:0;color:#0D0D0D" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.362 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg><a href="tel:${esc(shop.telefon.replace(/\s+/g, ''))}" style="color:inherit;text-decoration:underline">${esc(shop.telefon)}</a>${whatsappIcon}</span>`
    : ''
